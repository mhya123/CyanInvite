...
package cn.cyanbukkit.invatevelocity.config.serialization;

//import cn.cyanbukkit.vcyan.vcyan.editor.gameEdit.EditorGUI;
...
public class ConfigurationSerialization {
    ...
    protected ConfigurationSerializable deserializeViaMethod(@NotNull Method method, @NotNull Map<String, ?> args) {
        try {
            ...
            if (result == null) {
//                EditorGUI.logger.append("Could not call method '{}' of {} for deserialization: method returned null" + method + clazz);
            } else {
                return result;
            }
        } catch (Throwable ex) {
//            EditorGUI.logger.append(String.valueOf(ex));
        }
